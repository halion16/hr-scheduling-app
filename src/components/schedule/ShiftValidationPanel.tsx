...
export const ShiftValidationPanel: React.FC<ShiftValidationPanelProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      {/* Shifts List with Vertical Scrolling */}
        ...
        <div className="h-96 overflow-y-auto p-6">
          <div className="space-y-2">
            {filteredShifts.map(shift => {
              ...
              return (
                <div
                  key={shift.id}
                  className={`p-3 rounded-md border transition-colors ${statusConfig.bgColor} ${statusConfig.borderColor} ${isSelected ? 'ring-2 ring-blue-500' : ''} hover:shadow-sm`}
                >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <input
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        <span className={`inline-flex px-1.5 py-0.5 text-xs font-medium rounded ${statusConfig.bgColor} ${statusConfig.textColor} ${statusConfig.borderColor} border`}>
          ...
          {filteredShifts.length === 0 && (
            <div className="text-center py-8">
              ...
              <h3 className="text-sm font-medium text-gray-900 mb-1">Nessun turno trovato</h3>
